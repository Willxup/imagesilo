...
export type MigrationImage = components['schemas']['MigrationImage']
export type MigrationImageList = components['schemas']['MigrationImageList']
export type MigrationImageBatchResult = components['schemas']['MigrationImageBatchResult']
